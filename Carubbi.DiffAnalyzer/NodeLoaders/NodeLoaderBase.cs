...
namespace Carubbi.DiffAnalyzer.NodeLoaders
{
    ...
    public abstract class NodeLoaderBase
    {
        ...
        protected Action<Type, object, object, List<DiffComparison>> LoadTypeNodeHandler;

        protected NodeLoaderBase(Action<Type, object, object, List<DiffComparison>> loadTypeNodeHandler)
        {
            LoadTypeNodeHandler = loadTypeNodeHandler;
        }       
